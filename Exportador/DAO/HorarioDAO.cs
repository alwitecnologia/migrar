...
namespace Exportador.Helpers
{
    public class HorarioDAO
    {
        ...
        public static void CadastrarHorario(IdentificacaoHorario horario)
        {
            ...
            database.AddInParameter(command, "@p2", DbType.String, horario.CodHorario.PadLeft(4, '0'));
        ...
        private static void CadastrarIndiceHorario(BatidasNormais batida) 
        {
            ...
            database.AddInParameter(command, "@CODHORARIO", DbType.String, batida.CodHorario.PadLeft(4, '0'));
